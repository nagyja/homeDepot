...
const Departments = ({ action, onActionSelect}) =>{
  const deptLinks = [
    {deptLink: "" , text: "Christmas Decorations"},
    {deptLink: "" , text: "Appliances"},
    {deptLink: "" , text: "Bath & Faucets"},
    {deptLink: "" , text: "Blinds & Window Treatments"},
    {deptLink: "" , text: "Builders Materials"},
    {deptLink: "" , text: "Decor & Furniture"},
    {deptLink: "" , text: "Doors & Windows"},
    {deptLink: "" , text: "Electrical"},
    {deptLink: "" , text: "Flooring & Area Rugs"},
    {deptLink: "" , text: "Hardware"},
    {deptLink: "" , text: "Heating & Cooling"},
    {deptLink: "" , text: "Kitchen & Kitchenware"},
    {deptLink: "" , text: "Lawn & Garden"},
    {deptLink: "" , text: "Lighting & Ceiling"},
    {deptLink: "" , text: "Outdoor Living"},
    {deptLink: "" , text: "Paint"},
    {deptLink: "" , text: "Plumbing"},
    {deptLink: "" , text: "Storage & Organization"},
    {deptLink: "" , text: "Tools"}];
  //assign id to mapped elements    
  const mappedDept = deptLinks.map((dept)=>
      <a href={dept.deptLink} key={dept.text} title={dept.text} onClick={()=>onActionSelect(action)}>{dept.text}</a>
  );
